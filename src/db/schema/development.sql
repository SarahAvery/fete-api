...
VALUES
  ...
  (2,	2,	1,	'Choose Menu',	'Undecided on soup starter. 4 Vegetarians. 3 Vegans',	2500, 0),
  (2,	3,	1,	'Find Something Blue',	'Cousin to lend her brooch', DEFAULT, DEFAULT),
  (3,	0,	1,	'Venue Booking',	'The Country House Hotel',	15000,	16872),
  (3,	1,	1,	'Cake',	'Bakerbots or Milkbar',	800, DEFAULT),
  (4,	0,	1,	'Seating Chart',	'Keep Uncle Jim far away from Aunt Stella', DEFAULT, DEFAULT),
  ...
  (7,	2,	1,	'Deposit for rings',	'Vaughan Vintage and Specialty Jewellery',	200,	226),
  ...
  (9,	2,	1,	'Venue Booking',	'The Country House Hotel',	12343,	11500),
